...
MODEL_URL_OR_PATH = os.getenv("https://storage.googleapis.com/capstone-c242-ps370.appspot.com/ml-models/menu-recommendation/Ejajan_recommendation_model.tflite", "../model/Ejajan_recommendation_model.tflite")  # Default to local if not set
